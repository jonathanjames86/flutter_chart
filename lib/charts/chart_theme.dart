...
abstract class ChartTheme {
  ...
  int getColorForKey(key, [int state]);
  ...
  double get defaultSeparatorWidth => 1.0;
  ...
  AbsoluteRect get padding => const AbsoluteRect(10.0, 10.0, 10.0, 10.0);

  ChartTextTheme getTextTheme() => null;
}

// TODO (midoringo): add more text styles here
abstract class ChartTextTheme {
  TextStyle get axisTicksTextStyle;
}
