...
abstract class CartesianRenderer extends ChartRenderer {
  ...
  /// Render series data on the passed [canvas].
  /// paint will not be successful if [prepare] was not already called.
...
abstract class ChartRenderer extends ChartRendererBehaviorSource {
  ...
  /// - [rdrObj] represents the [CartesianChartRenderObject] that renders the
  /// chart.
