...
part of charted.flutter.core.interpolators;
...
Interpolator createStringInterpolator(String a, String b) {
  ...
  if (ColorUtil.isRgbColorString(a) && ColorUtil.isRgbColorString(b)) {
    return createRgbColorInterpolator(
        ColorUtil.fromRgbString(a), ColorUtil.fromRgbString(b));
  }
...
Interpolator createRgbColorInterpolator(Color a, Color b) {
  if (a == null || b == null) return (t) => b;
  var ar = a.red, ag = a.green, ab = a.blue,
      br = b.red - ar, bg = b.green - ag, bb = b.blue - ab;

  return (t) => new Color.fromARGB(0xFF, (ar + br * t), (ag + bg * t),
      (ab + bb * t));
}
